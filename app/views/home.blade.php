...
<html>
  ...
  <head>
    ...
    <link href="{{ asset('bower_components/thema/css/soon.css')}}" rel="stylesheet">


    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
      <script src="{{ asset('bower_components/thema/js/html5shiv.js')}}"></script>
      <script src="{{ asset('bower_components/thema/js/respond.min.js')}}"></script>
    <![endif]-->
  ...
  <body class="nomobile">
    ...
    <section id="header">
        <div class="container">
            <header>
                <!-- HEADLINE -->
                <h1 data-animated="GoIn"><b>NOSSO CONGRESSO</b> em breve...</h1>
            </header>
            <!-- START TIMER -->
        ...
        <div id="slider" class="rev_slider">
            <ul>
              ...
              <li data-transition="slideleft" data-slotamount="1" data-thumb="{{url('media/slider/3.jpg')}}">
                <img src="{{url('media/slider/3.jpg')}}">
              </li>
	...
	<script type="text/javascript" src="{{ asset('bower_components/thema/js/modernizr.custom.js') }}"></script>
    <script src="{{ asset('bower_components/bootstrap/dist/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('bower_components/thema/js/soon/plugins.js') }}"></script>
    <script src="{{ asset('bower_components/thema/js/soon/jquery.themepunch.revolution.min.js') }}"></script>
    <script src="{{ asset('bower_components/thema/js/soon/custom.js') }}"></script>
  </body>
  <!-- END BODY -->
</html>