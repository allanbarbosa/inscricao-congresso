...
(function($) {
    ...
    **/
    var launch = new Date(2015, 04, 10, 8, 00);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            message.html('O Evento já começou. Em breve fotos!');
        }
        else{
            ...
            message.html('Os dias estão passando. Você ficará de fora do maior evento espirita da Bahia?');
        }
    }
})(jQuery);
/******************************************************************************************************************************
